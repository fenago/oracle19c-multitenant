...
create table oe.customers sharing=object (
 CUSTOMER_ID		NUMBER(6),
...
create table oe.product_information sharing=object (
 PRODUCT_ID           NUMBER(6),
...
@/home/oracle/labs/perf/script_customers.sql
@/home/oracle/labs/perf/script_product_information.sql
...
drop table oe.part;
create table oe.part sharing=object (
P_PARTKEY number,
P_NAME varchar(22),
P_MFGR char(6),
P_CATEGORY char(7),
...
create table oe.date_dim sharing=object (
D_DATEKEY number,
D_DATE char(18),
D_DAYOFWEEK char(10),
D_MONTH char(9),
...
host sqlldr oe/Welcome_1@hr_root  control=/home/oracle/labs/perf/control_part.ctl
...
host sqlldr oe/Welcome_1@hr_root control=/home/oracle/labs/perf/control_date.ctl
