...
echo col PDB_NAME format A9 >> $ORACLE_HOME/sqlplus/admin/glogin.sql
...
echo col username format A10 >> $ORACLE_HOME/sqlplus/admin/glogin.sql
...
echo col APP_name format A8  >> $ORACLE_HOME/sqlplus/admin/glogin.sql
...
echo col CLAUSE format a13 >> $ORACLE_HOME/sqlplus/admin/glogin.sql
